        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex-shrink-0">
            <Link href="/" className="flex items-center gap-2 group">
              <div className="relative w-14 h-14 rounded-full overflow-hidden border-2 border-transparent group-hover:border-primary/20 shadow-sm transition-all duration-500">
                <Image
                  src="/logo.jpeg"
          ...
          <nav className="hidden md:flex items-center gap-2">
            ...
            <div className="pl-4 ml-2 border-l border-slate-200">
              <Link
                href="/rentals"
                className="px-6 py-2.5 rounded-full bg-primary text-white text-sm font-bold shadow-md shadow-primary/30 hover:shadow-lg hover:shadow-primary/40 hover:-translate-y-0.5 transition-all duration-300 active:scale-95 flex items-center gap-2"
              >
                <span>Book Now</span>
      ...
      >
        <div className="flex flex-col px-6 pt-4 pb-6 space-y-2">
          ...
          <Link
            href="/rentals"
            onClick={() => setIsMenuOpen(false)}
            className="mt-4 w-full text-center px-6 py-4 rounded-xl bg-primary text-white font-bold tracking-wide shadow-md shadow-primary/30 hover:shadow-lg hover:shadow-primary/40 hover:bg-primary/90 active:scale-[0.98] transition-all flex items-center justify-center gap-2"
          >
            <span>Book Now</span>
          </Link>
        </div>
